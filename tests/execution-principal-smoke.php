...
$principal = AgentsAPI\AI\WP_Agent_Execution_Principal::agent_token(
	123,
	'content-helper',
	456,
	...
	array(
		'request_id' => 'req-abc',
		'transport'  => AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_REST,
	),
	'site:42',
	'kimaki',
...
agents_api_smoke_assert_equals( AgentsAPI\AI\WP_Agent_Execution_Principal::AUTH_SOURCE_AGENT_TOKEN, $principal->auth_source, 'principal records auth source', $failures, $passes );
agents_api_smoke_assert_equals( AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_REST, $principal->request_context, 'principal records request context', $failures, $passes );
...
agents_api_smoke_assert_equals( AgentsAPI\AI\WP_Agent_Execution_Principal::AUTH_SOURCE_AGENT_TOKEN, $principal_array['auth_source'], 'principal exports auth source', $failures, $passes );
agents_api_smoke_assert_equals( AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_REST, $principal_array['request_context'], 'principal exports request context', $failures, $passes );
...
agents_api_smoke_assert_equals( AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_CHAT, $from_array->request_context, 'from_array normalizes request context', $failures, $passes );
...
add_filter(
	...
	static function ( $principal, array $context ) {
		if ( AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_REST !== ( $context['request_context'] ?? '' ) ) {
			return $principal;
		}
		...
		return array(
			...
			'auth_source'          => AgentsAPI\AI\WP_Agent_Execution_Principal::AUTH_SOURCE_AGENT_TOKEN,
...
$resolved = AgentsAPI\AI\WP_Agent_Execution_Principal::resolve(
	array( 'request_context' => AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_REST )
);
...
agents_api_smoke_assert_equals( AgentsAPI\AI\WP_Agent_Execution_Principal::AUTH_SOURCE_AGENT_TOKEN, $resolved->auth_source, 'resolve records token auth source', $failures, $passes );
...
try {
	new AgentsAPI\AI\WP_Agent_Execution_Principal( 1, '', AgentsAPI\AI\WP_Agent_Execution_Principal::AUTH_SOURCE_USER, AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_REST );
...
try {
	new AgentsAPI\AI\WP_Agent_Execution_Principal( 1, 'agent', AgentsAPI\AI\WP_Agent_Execution_Principal::AUTH_SOURCE_USER, AgentsAPI\AI\WP_Agent_Execution_Principal::REQUEST_CONTEXT_REST, null, array( 'resource' => $resource ) );
