...
smoke_assert( true, isset( $in['properties']['client_context']['properties']['context_binding'] ), 'client_context_schema_has_context_binding', $failures, $passes );
smoke_assert( true, isset( $in['properties']['client_context']['properties']['context_binding']['properties']['source_id'] ), 'context_binding_schema_has_source_id', $failures, $passes );
smoke_assert( true, isset( $in['properties']['client_context']['properties']['context_binding']['properties']['scope_id'] ), 'context_binding_schema_has_scope_id', $failures, $passes );
smoke_assert( true, isset( $in['properties']['client_context']['properties']['context_binding']['properties']['policy'] ), 'context_binding_schema_has_policy', $failures, $passes );
smoke_assert( true, isset( $in['properties']['client_context']['properties']['context_binding']['properties']['current_item_id'] ), 'context_binding_schema_has_current_item_id', $failures, $passes );
