...
smoke_assert( false, isset( $in['properties']['client_context']['properties']['runtime_tools'] ), 'client_context_schema_omits_runtime_tools', $failures, $passes );
smoke_assert( false, isset( $in['properties']['client_context']['properties']['runtime_tool_declarations'] ), 'client_context_schema_omits_runtime_tool_declarations', $failures, $passes );
smoke_assert( false, isset( $in['properties']['client_context']['properties']['runtime_tool_callback'] ), 'client_context_schema_omits_runtime_tool_callback', $failures, $passes );
